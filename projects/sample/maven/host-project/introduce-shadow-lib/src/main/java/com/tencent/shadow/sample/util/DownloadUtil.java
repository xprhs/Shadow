package com.tencent.shadow.sample.util;
...
public class DownloadUtil {
    ...
    private String isExistDir(String saveDir) throws IOException {
        ...
        if(!downloadFile.exists()) {
            // 下载位置
            downloadFile = new File(Environment.getExternalStorageDirectory().getPath() + "/download/", saveDir);
            if (!downloadFile.mkdirs()) {
                downloadFile.createNewFile();
            }

            saveDir = downloadFile.getAbsolutePath();
        }
